...
import {
    ...
    Select, Table, Thead, Tbody, Tr, Th, Td, useColorMode,
...
// ─── Stat Card ───
const StatCard = ({ icon, label, value, change, index, T, glass }) => (
    <MotionBox
...
// ─── Chart Container ───
const ChartBox = ({ title, icon, children, delay = 0, T, glass }) => (
    <MotionBox
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay }}
...
export default function PerformanceAnalytics() {
    ...
    const chartTooltipStyle = getChartTooltipStyle(T);
        ...
        <Box minH="100vh" bg={T.bg} color={T.white} position="relative" overflow="hidden">
            ...
            <Box maxW="1400px" mx="auto" p={{ base: 4, md: 6, xl: 8 }} pb={20} position="relative" zIndex={1}>
                ...
                <SimpleGrid columns={{ base: 2, md: 4 }} spacing={4} mb={8}>
                    <StatCard icon={FiEye} label="Total Reach" value="64K" change={23.5} index={0} T={T} glass={glass} />
                    <StatCard icon={FiHeart} label="Engagements" value="3.8K" change={12.1} index={1} T={T} glass={glass} />
                    <StatCard icon={FiUsers} label="Followers" value="7.8K" change={18.2} index={2} T={T} glass={glass} />
                    <StatCard icon={FiShare2} label="Shares" value="780" change={-3.4} index={3} T={T} glass={glass} />
                </SimpleGrid>

                {/* ── Charts Row 1 ── */}
                <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6} mb={6}>
                    {/* Engagement Over Time */}
                    <ChartBox title="Engagement Metrics" icon={FiTrendingUp} delay={0.2} T={T} glass={glass}>
                        <Box h="280px">
                    ...
                    {/* Platform Comparison */}
                    <ChartBox title="Platform Comparison" icon={FiBarChart2} delay={0.3} T={T} glass={glass}>
                        <Box h="280px">
                            <ResponsiveContainer width="100%" height="100%">
                ...
                <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6} mb={6}>
                    {/* Growth Trends */}
                    <ChartBox title="Growth Trends" icon={FiTrendingUp} delay={0.4} T={T} glass={glass}>
                        <Box h="280px">
                            <ResponsiveContainer width="100%" height="100%">
                    ...
                    {/* Audience Breakdown */}
                    <ChartBox title="Audience Engagement" icon={FiUsers} delay={0.5} T={T} glass={glass}>
                ...
                {/* ── Top Posts Table ── */}
                <ChartBox title="Post Performance" icon={FiBarChart2} delay={0.6} T={T} glass={glass}>
                    <Box overflowX="auto">
