...
export default function WelcomeScreen({ children }) {
    ...
    const canProceed = useCallback(() => {
        switch (step) {
            ...
            case 2: return form.toneOfVoice.length > 0;
            case 3: return true;
            case 4: return true;
            case 5: return true;
            default: return false;
        }
    }, [step, form.brandName, form.toneOfVoice]);
                    ...
                    >
                        ...
                        <VStack spacing={6} align="stretch">
                            ...
                            <Text fontSize="xs" color="gray.600" textAlign="center">
                                Your Brand DNA shapes all content across the platform — press Enter to continue
                            </Text>
                        </VStack>
                    </MotionBox>
                </MotionBox>
